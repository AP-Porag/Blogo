    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header border-2 bg-gradient-navy">
                        ...
                        <div class="card-footer bg-gradient-navy text-right">
                            <a href="{{route('category.edit',[$category->id])}}" class="btn btn-outline-light">Edit Category</a>
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
